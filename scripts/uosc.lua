...
function update_margins()
	...
	if controls and controls.enabled then bottom = (display.height - controls.ay) / display.height
	elseif timeline and timeline.enabled then bottom = (display.height - timeline.ay) / display.height end
